...
public class SentenceDetectorFactory {
  ...
  /** Obtain a reference to an english nlp.sentence detector to use in conjunction
  ...
  /** Load the nlp.sentence detector
   * 
   * @param language
  ...
  protected void loadSentenceDetector(String language, String modelDirectory) throws IOException {
    ...
    log.info("Loading nlp.sentence model {}", modelFile);
