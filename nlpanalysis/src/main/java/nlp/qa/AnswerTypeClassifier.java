...
public class AnswerTypeClassifier {
  ...
  */
    ...
    public static void main(String[] args) throws IOException {
        ...
        String modelsDirProp = "/home/bibek/bs-workspace/tamingtext_resources/opennlp-models";
        File modelsDir = new File(modelsDirProp);
        String wordNetDir = "/home/bibek/bs-workspace/tamingtext_resources/WordNet-3.0/dict";
        InputStream chuckerStream = new FileInputStream(new File(modelsDir, "en-chunker.bin"));
        ChunkerModel chunkerModel = new ChunkerModel(chuckerStream);
