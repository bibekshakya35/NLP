...
import nlp.opennlp.JWNLDictionary;
...
/**
 * Identify the features of the question by leveraging Wordnet and
 * using the parse of the question
...
public class AnswerTypeContextGenerator {
    ...
    private Parse[] getNounPhrases(Parse parse) {
        List<Parse> nps = new ArrayList<>(10);
