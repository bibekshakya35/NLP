...
public class WikiClean {
    ...
    private boolean withTitle, withFooter;
    private WikiLanguage language;
    ...
    public String clean(String content) {
        ...
        content = org.apache.commons.lang3.StringEscapeUtils.unescapeHtml4(org.apache.commons.lang3.StringEscapeUtils.unescapeHtml4(content));
    ...
    protected String removeFooter(String s) {
        if (this.language.equals(WikiLanguage.EN)) {
        ...
        } else if (this.language.equals(WikiLanguage.DE)) {
        ...
        } else if (this.language.equals(WikiLanguage.ZH)) {
    ...
    protected String removeCategoryLinks(String s) {
        ...
        if (this.language.equals(WikiLanguage.DE)) {
            return CATEGORY_LINKS_DE.matcher(s).replaceAll("");
        }

        if (this.language.equals(WikiLanguage.ZH)) {
